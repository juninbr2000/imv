...
const Search = ({onFilterChange}) => {
    ...
    const saleValue = [
        {
            value: 100000,
            text: 'até R$ 100.000,00',
        },
        {
            value: 250000,
            text: 'até R$ 250.000,00',
        },
        {
            value: 500000,
            text: 'até R$ 500.000,00',
        },
        {
            value: 750000,
            text: 'até R$ 750.000,00',
        },
        {
            value: 1000000,
            text: 'até R$ 1.000.000,00',
        },
        {
            value: 2500000,
            text: 'até R$ 2.500.000,00',
        },
        {
            value: 5000000,
            text: 'até R$ 5.000.000,00'
        }
    ]
    ...
    const handleFilterChange = (e) => {
        e.preventDefault();
        onFilterChange(isAluguel, local, isSale, tipoImv, maxCost);
    };
    ...
    <div className={styles.form_container}>
        <div className={styles.container}>
            <div className={styles.logo}>
                ...
                <h3 className={styles.subtitle}>Te ajudamos a encotrar o seu lar ideal</h3>
            </div>
            <form className={styles.form_area} onSubmit={handleFilterChange}>
                ...
                <div className={styles.select_area}>
                    <label className={styles.select}>
                        <span><BiCurrentLocation/> Cidade</span>
                        <select name="city">
                            <option value="lambari">Lambari</option>
                        </select>
                    </label>
                    <label className={styles.select}>
                        <span><FaRegMap/> Localização</span>
                ...
                <div className={styles.select_area}>
                    <label className={styles.select}>
                        <span><BiBuildingHouse/> Tipo</span>
                    ...
                    <label className={styles.select}>
                        ...
                        <select name="valor" onChange={(e) => setMaxCost(e.target.value)}>
                            ...
                            {(isSale === false && isAluguel === false) && getAllValues.map((preco, index) => (
                                <option key={index} value={preco.value}>{preco.text}</option>
                            ))}
                            {isAluguel === true && aluguelValue.map((preco, index) => (
                                <option key={index} value={preco.value}>{preco.text}</option>
                            ))}
                        </select>
                    </label>
            ...
            <div className={styles.announce}>
                ...
                <Link to={'https://wa.me/5535998990790'} className='secondary_btn'>Anunciar meu Imóvel</Link>
            </div>
        </div>
    </div>
  )
